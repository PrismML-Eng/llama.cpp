...
template <typename type4x4>
void dequantize_q2_0_g128(device const block_q2_0_g128 * xb, short il, thread type4x4 & reg) {
    device const uint8_t * qs = xb->qs;
    const float d = xb->d;
...
template <typename type4>
void dequantize_q2_0_g128_t4(device const block_q2_0_g128 * xb, short il, thread type4 & reg) {
    const float d = xb->d;
    const uint8_t b = xb->qs[il];
...
void quantize_q2_0_g128(device const float * src, device block_q2_0_g128 & dst) {
    float amax = 0.0f;
    for (int j = 0; j < QK2_0_G128; j++) {
        float a = fabs(src[j]);
        if (a > amax) amax = a;
    }
    const float d = amax;
...
inline float block_q_n_dot_y(device const block_q2_0_g128 * qb_curr, float sumy, thread float * yl, int il) {
    device const uint8_t * qs = qb_curr->qs + (il / 4);
    const uint8_t b0 = qs[0];
    const uint8_t b1 = qs[1];
    const uint8_t b2 = qs[2];
...
void kernel_mul_mv_q2_0_g128_f32_impl(
    ...
    const int nb = args.ne00/QK2_0_G128;
    ...
    device const block_q2_0_g128 * ax[nr0];
    for (int row = 0; row < nr0; ++row) {
        const uint64_t offset0 = (first_row + row)*args.nb01 + (i12/FC_mul_mv_r2)*args.nb02 + (i13/FC_mul_mv_r3)*args.nb03;
        ax[row] = (device const block_q2_0_g128 *) ((device char *) src0 + offset0);
    }

    float yl[16];
    float sumf[nr0] = {0.f};

    // group 128: 8 sub-blocks of 16 weights per Q2_0_g128 block
    const short ix = (tiisg/8);
    const short il = (tiisg%8)*16;

    device const float * yb = y + ix*QK2_0_G128 + il;
...
[[host_name("kernel_mul_mv_q2_0_g128_f32")]]
kernel void kernel_mul_mv_q2_0_g128_f32(
        constant ggml_metal_kargs_mul_mv & args,
        device const char * src0,
        device const char * src1,
        device       char * dst,
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_q2_0_g128_f32_impl<N_R0_Q2_0_G128, constant ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
template [[host_name("kernel_mul_mv_ext_q2_0_g128_f32_r1_2")]]   kernel mul_mv_ext_q4_f32_t kernel_mul_mv_ext_q4_f32_disp<2, block_q2_0_g128,    128, dequantize_q2_0_g128_t4>;
...
template [[host_name("kernel_mul_mv_ext_q2_0_g128_f32_r1_3")]]   kernel mul_mv_ext_q4_f32_t kernel_mul_mv_ext_q4_f32_disp<3, block_q2_0_g128,    128, dequantize_q2_0_g128_t4>;
...
template [[host_name("kernel_mul_mv_ext_q2_0_g128_f32_r1_4")]]   kernel mul_mv_ext_q4_f32_t kernel_mul_mv_ext_q4_f32_disp<4, block_q2_0_g128,    128, dequantize_q2_0_g128_t4>;
...
template [[host_name("kernel_mul_mv_ext_q2_0_g128_f32_r1_5")]]   kernel mul_mv_ext_q4_f32_t kernel_mul_mv_ext_q4_f32_disp<5, block_q2_0_g128,    128, dequantize_q2_0_g128_t4>;
...
template [[host_name("kernel_cpy_f32_q2_0_g128")]]   kernel cpy_f_q_t kernel_cpy_f32_q<QK2_0_G128,  block_q2_0_g128,   quantize_q2_0_g128>;
...
template [[host_name("kernel_cpy_q2_0_g128_f32")]] kernel cpy_q_f_t kernel_cpy_q_f32<float4x4, block_q2_0_g128, 8, dequantize_q2_0_g128>;
...
template [[host_name("kernel_cpy_q2_0_g128_f16")]] kernel cpy_q_f_t kernel_cpy_q_f32<half4x4, block_q2_0_g128, 8, dequantize_q2_0_g128>;
...
template [[host_name("kernel_get_rows_q2_0_g128")]]    kernel get_rows_q_t kernel_get_rows_q<block_q2_0_g128,    8, dequantize_q2_0_g128>;
...
template [[host_name("kernel_mul_mm_q2_0_g128_f32")]]    kernel mul_mm_t kernel_mul_mm<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_q2_0_g128,    8,     dequantize_q2_0_g128,    float,  float4x4,  float, float2x4>;
...
template [[host_name("kernel_mul_mm_q2_0_g128_f16")]]    kernel mul_mm_t kernel_mul_mm<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_q2_0_g128,    8,     dequantize_q2_0_g128,    float,  float4x4,  half, half2x4>;
...
template [[host_name("kernel_mul_mm_id_q2_0_g128_f32")]]    kernel mul_mm_id kernel_mul_mm_id<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_q2_0_g128,    8,     dequantize_q2_0_g128,    float,  float4x4,  float, float2x4>;
...
template [[host_name("kernel_mul_mm_id_q2_0_g128_f16")]]    kernel mul_mm_id kernel_mul_mm_id<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_q2_0_g128,    8,     dequantize_q2_0_g128,    float,  float4x4,  half, half2x4>;
...
template [[host_name("kernel_mul_mv_id_q2_0_g128_f32")]]    kernel kernel_mul_mv_id_t kernel_mul_mv_id<mmv_fn<kernel_mul_mv_q2_0_g128_f32_impl<N_R0_Q2_0_G128>>>;
