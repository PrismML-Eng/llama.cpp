...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_PQ1_0] = {
        .type_name                = "pq1_0",
        .blck_size                = QK_PQ1_0,
        .type_size                = sizeof(block_pq1_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_pq1_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_pq1_0_ref,
    },
    [GGML_TYPE_Q2_0] = {
        .type_name                = "q2_0",
        .blck_size                = QK2_0,
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_PQ1_0:     wtype = GGML_TYPE_PQ1_0; break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_PQ1_0:   result = quantize_pq1_0  (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
