...
SOURCE_FATTN_MMA_Q8_0_CASE = "DECL_FATTN_MMA_Q8_0_CASE({head_size_kq}, {head_size_v}, {ncols1}, {ncols2});\n"
...
for ncols in [8, 16, 32, 64]:
    for ncols2 in [1, 2, 4, 8, 16, 32]:
        ...
        with open(f"fattn-mma-f16-instance-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
            ...
            # q8_0 KV decoded inside the kernel, used by the fused decode path in fattn.cu
            if ncols2 == 8:
                f.write(SOURCE_FATTN_MMA_Q8_0_CASE.format(ncols1=ncols1, ncols2=ncols2, head_size_kq=256, head_size_v=256))
