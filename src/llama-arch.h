...
enum llm_kv {
    ...
    LLM_KV_HADAMARD_VERSION,
    LLM_KV_HADAMARD_BLOCK_SIZE,
    LLM_KV_HADAMARD_TRANSFORM,
    LLM_KV_HADAMARD_AXIS,
    LLM_KV_HADAMARD_SIGN_MODE,
    LLM_KV_HADAMARD_SIGN_WIDTHS,
    LLM_KV_HADAMARD_SIGN_VALUES,
    LLM_KV_HADAMARD_WEIGHT_NAMES,
    LLM_KV_HADAMARD_INVERSE_WEIGHT_NAMES,
    LLM_KV_HADAMARD_GDN_V_GROUPED,
